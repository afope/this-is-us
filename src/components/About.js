...
export default class About extends Component {
  render() {
    return (
      <div className="about">
        <div className="row">
          <img src={imageOne} className="about-img" alt="about the cotton" />
          <p>
        ...
        <div className="row">
          <img src={imageTwo} alt="about the cotton" className="about-img" />
          <p>
        ...
        <div className="row">
          <img src={imageThree} alt="about the cotton" className="about-img" />
        ...
        <div className="row">
          <img src={imageFour} alt="about the cotton" className="about-img" />
        ...
        <div className="row">
          <img src={imageSix} alt="about the cotton" className="about-img" />
